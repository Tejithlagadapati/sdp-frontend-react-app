...
const Infrastructure = () => {
    ...
    const handleDelete = async (serviceId) => {
        const confirmed = window.confirm("Delete this infrastructure item?");
        ...
        try {
            ...
            setError(deleteError?.response?.data?.message || deleteError.message || "Failed to delete infrastructure");
        } finally {
            setDeletingId(null);
        }
    };
