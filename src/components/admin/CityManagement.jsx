...
import { addService, deleteService, fetchPublicServices, SERVICE_TYPES } from "../../services/serviceApi";
...
const CityManagement = () => {
  ...
  const handleDelete = async (serviceId) => {
    ...
    try {
      ...
      setError(deleteError?.response?.data?.message || deleteError.message || "Failed to delete service");
    } finally {
      setDeletingId(null);
    }
  };
